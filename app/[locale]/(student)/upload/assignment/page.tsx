...
import { ChevronLeft, FileText, Upload, X, CheckCircle2 } from "lucide-react";
    ...
    <div className="min-h-screen" style={{ background: "#F6F7F8" }}>
      <div className="container mx-auto px-6 py-12 max-w-2xl">
        ...
        <form action={formAction} className="flex flex-col gap-6">
          ...
          <input type="hidden" name="successType" value="assignment" />
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-xs mt-1" style={{ color: "#667085" }}>
                  or click to browse — PDF, DOCX, ZIP, XLSX (Max 500MB)
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Describe what you need help with — specific questions, topics, or areas of focus..."
              rows={3}
